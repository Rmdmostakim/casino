...
<div class="container-fluid jumbotron homeBody" >           
    <div class="gameBox mt-5">
        ...
        <div class="coin" id="coin">
            <div class="heads">
                <img src="{{asset('icon/king.svg')}}">
            </div>
            <div class="tails">
                <img src="{{asset('icon/queen.svg')}}">
            </div>
        </div>
                ...
                <div class="form-row align-items-center">
                    <div class="col-auto ml-4">
                        ...
                        <div class="col-auto my-1">
                            <label class="mr-sm-2 text-primary font-weight-bold" for="selectedCard">Select King/Queen</label>
...
<script type="text/javascript">
    ...
    function GameStatus(amount,gamecard){
        let data   = {amount:amount,card:gamecard,gamename:"King&Queen"};
        let url    = 'king&queenresult';
        var config = {
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            }
