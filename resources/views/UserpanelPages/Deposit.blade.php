            ...
            <div class="container">
                <div class="account__main__wrapper">
                    <div class="account__form__wrapper sign-up">
                        ...
                        @endif
                        <form class="account__form form row g-4" method="post" action="{{ route('deposit.request') }}">
                            @csrf
                            @method('post')
                            <div class="col-xl-6 col-md-6" id="account-handler">
                                <div class="form-group">
                                    <div for="account-number" class="input-pre-icon"><i class="las la-phone"></i></div>
                                    <input id="account-number" type="text" name="transfer_number" value="{{ old('transfer_number') }}" class="form--control form-control style--two" placeholder="Your account" required>
                                </div>
                            ...
                            <div class="col-xl-6 col-md-6" id="amount-handler">
                                <div class="form-group">
                                    ...
                                    <input id="amount" type="text" name="balance_amount" value="{{ old('balance_amount') }}" class="form--control form-control style--two" placeholder="Amount" required onkeyup="currencyConvert()">
                                </div>
                            ...
                            <div class="col-lg-12">
                                <input class="form--control form-control style--two" id="converted_amount" type="text" placeholder="Balance to UC = 0" readonly>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <button class="cmn--btn active w-100 btn--round" type="submit">Make Deposit</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="account__content__wrapper" >
                        <div class="content text-center text-white">
                            ...
                            <a href="{{ route('faq') }}" class="mt-3 btn btn-link btn--sm radius-5">Deposit Instruction <i class="las la-info-circle"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function currencyConvert(){
            ...
            axios.post("{{ route('currency.converter') }}",{method_name:method_name,balance_amount:balance_amount})
                    .then(function (response) {
                        document.getElementById("converted_amount").value = 'Balance to UC = '+response.data;
                    })
