    ...
    <div class="col-lg-9">
        <div class="table--responsive--md">
            ...
            <table class="table" id="dataTable">
                ...
                <tbody>
                @foreach( \AdminAuth::pendingDeposit() as $balance)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn--success btn--sm mb-1" href="{{ route('admin.confirmdeposit',\Crypt::encryptString($balance->id)) }}" title="Confirm"><i class="las la-check-square"></i></a>
                            <a class="btn btn--danger btn--sm" href="{{ route('admin.rejectdeposit',\Crypt::encryptString($balance->id)) }}" title="Reject"><i class="las la-trash"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
