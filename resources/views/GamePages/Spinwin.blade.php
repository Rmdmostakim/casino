            ...
            <div class="row gy-5">
                <div class="col-lg-6">
                    <div class="game-details-left">
                        <div id="coin-flip-cont">
                            <div class="">
                                <div class="front"><img src="{{asset('images/game/spinningwheel.gif')}}" alt="game"></div>
                            </div>
                        </div>
                        <div class="cd-ft"></div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="game-details-right">
                        <form method="get" action="{{ route('SpinWin') }}">
                            <div class="container parent">
                                <div class="row">
                                    ...
                                    <div class="form-group mb-5" id="invest-handler">
                                        ...
                                        @enderror
                                        <small class="form-text text-muted"><i class="fas fa-info-circle mr-2"></i>Minimum: 10<i class="la la-bitcoin"></i> | Maximum: 500<i class="la la-bitcoin"></i> | <span class="text-warning">Win Amount {{ \Gameplay::gameRate('king&queen') }} %</span></small>
                                    </div>
                                    <div class="row" id="choosed-handler">
                                        <div class='col text-center'>
                                            <input type="radio" name="choosed" id="img1" class="d-none imgbgchk" value="red">
                                            <label for="img1">
                                                <img src="{{asset('images/game/spinwin/red.png')}}" alt="red.png">
                                        ...
                                        <div class='col text-center'>
                                            <input type="radio" name="choosed" id="img2" class="d-none imgbgchk" value="blue">
                                            <label for="img2">
                                                <img src="{{asset('images/game/spinwin/blue.png')}}" alt="blue.png">
                                                <div class="tick_container">
                                                    <div class="tick"><i class="fa fa-check"></i></div>
                                                </div>
                                            </label>
                                        ...
                                        <div class='col text-center'>
                                            <input type="radio" name="choosed" id="img3" class="d-none imgbgchk" value="green">
                                            <label for="img3">
                                                <img src="{{asset('images/game/spinwin/green.png')}}" alt="green.png">
                                                <div class="tick_container">
                                                    <div class="tick"><i class="fa fa-check"></i></div>
                                                </div>
                                            </label>
                                        ...
                                        <div class='col text-center'>
                                            <input type="radio" name="choosed" id="img4" class="d-none imgbgchk" value="yellow">
                                            <label for="img4">
                                                <img src="{{asset('images/game/spinwin/yellow.png')}}" alt="yellow.png">
                                                <div class="tick_container">
                                                    <div class="tick"><i class="fa fa-check"></i></div>
                                                </div>
                                            </label>
