            ...
            <div class="row gy-5">
                    ...
                    <div class="game-details-left">
                        <div id="coin-flip-cont">
                            <div class="coins-wrapper">
                                <div class="front"><img src="{{asset('images/game/even.png')}}" alt="game"></div>
                                <div class="back"><img src="{{asset('images/game/odd.png')}}" alt="game"></div>
                            </div>
                        </div>
                        <div class="cd-ft"></div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="game-details-right">
                        <form method="get" action="{{route('EvenOdd')}}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row" id="choosed-handler">
                                        <div class='col text-center'>
                                            <input type="radio" name="choosed" id="img1" class="d-none imgbgchk" value="even">
                                            <label for="img1">
                                                <img src="{{asset('images/game/even.png')}}" alt="even.png">
                                        ...
                                        <div class='col text-center'>
                                            <input type="radio" name="choosed" id="img2" class="d-none imgbgchk" value="odd">
                                            <label for="img2">
                                                <img src="{{asset('images/game/odd.png')}}" alt="odd.png">
                                                <div class="tick_container">
                                                    <div class="tick"><i class="fa fa-check"></i></div>
                                                </div>
                                            </label>
